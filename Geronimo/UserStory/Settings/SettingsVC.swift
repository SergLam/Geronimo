...
final class SettingsVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillLayoutSubviews() {
       super.viewWillLayoutSubviews()
        for constraint in settingTable.constraints where  constraint.identifier == "tableHeight" {
            
            constraint.constant = settingTable.contentSize.height
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = settingTable.dequeueReusableCell(withIdentifier: cellName, for: indexPath) as? SettingsTableCell else {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        let label = UILabel(frame: CGRect(x: 20, y: 15, width: settingTable.bounds.size.width, height: 20))
    ...
    @IBAction private func dismissSettingsVC(_ sender: UIBarButtonItem) {
